...
X = input("Please provide date in YYYY-MM-DD format: ")
...
dateformat='date='
DATE = X
MYKEY = '&api_key=SfisQIwsQRR5YMMzbVfZRCPM10ttqLE2IYpvEZHm' ## this is our api key

## pretty print json
def main():
    """run-time code"""
    nasaapiobj = requests.get(NASAAPI + dateformat + DATE + MYKEY) # call the webservice
